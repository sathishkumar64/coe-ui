 ...
 *//**
	 ...
	 *//*
		 ...
		 * "/api/v1/coe/school/all").authenticated() .antMatchers(HttpMethod.GET,
		 * "/api/v1/coe/school/getStudentsBySchool/*").hasRole("readschool")
		 * .antMatchers(HttpMethod.POST, "/api/v1/coe/school").hasRole("createschool");
		 * } }
		 */