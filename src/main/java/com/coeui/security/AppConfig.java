...
public class AppConfig extends WebSecurityConfigurerAdapter {
	/**
	 * This is your auth0 domain (tenant you have created when registering with
	 * auth0 - account name)
	 */
	...
	/**
	 * This is the client id of your auth0 application (see Settings page on auth0
	 * dashboard)
	 */
	...
	/**
	 * This is the client secret of your auth0 application (see Settings page on
	 * auth0 dashboard)
	 */
