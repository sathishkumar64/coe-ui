 ...
 * .paths(regex("/api.*")) .build() .apiInfo(metaData()); } private ApiInfo
 * metaData() { return new
 * ApiInfoBuilder().title("RESTful API's for COE Istio Service")
 * .description("RESTful API's for COE IstioR Service").
